...
export default function Header() {
  ...
  return (
    <header className="w-full sticky top-0 z-50 px-6 flex items-center bg-[#1E1E1E]/75 h-[80px] md:px-24">
      ...
      {/* Sidebar para Mobile */}
      <div className={`fixed inset-y-0 left-0 transform ${isMenuOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out bg-[#1E1E1E]/75 p-4 w-64 h-full md:hidden z-50`} ref={ref}>
